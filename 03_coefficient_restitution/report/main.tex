...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{imgs/app.png}
    \caption{Vista general de la aplicación web del Coeficiente de Restitución integrada al Bento Launcher.}
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item De Armas Castaño, G. et al. (2025). \textit{Sensado y Modelado de Sistemas Físicos — Repositorio del curso}. Universidad Tecnológica de Bolívar. Disponible en: \url{https://github.com/Gdearmascasta/Sensado_y_modeladoSF}
\end{enumerate}
